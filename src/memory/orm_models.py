...
class FindingRecord(Model):
    ...
    root_cause_class = fields.CharField(max_length=64, null=True)
...
class AgentHandoffRecord(Model):
    ...
    severity = fields.CharField(max_length=32)
    kind = fields.CharField(max_length=32, default="code")
    confidence = fields.FloatField(default=0.5)
...
class SkillEvaluationRecord(Model):
    ...
    mode = fields.CharField(max_length=32, default="heuristic")
